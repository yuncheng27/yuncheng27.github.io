...
var SimpleCore = {
    ...
    /**
     * Press Alt to hide server pop :)
     */
    registerESCKeyEvent: function() {
        $(document).on('keyup', function(event) {
            var shouldDismissSearchPopup = event.which === 18
    ...
    /**
     * Press S to active local-search  //keycode查询:https://css-tricks.com/snippets/javascript/javascript-keycodes/
     */
    registerFKeyEvent: function(e) {
        $(document).on('keyup', function(event) {
            var shouldShowSearchPopup = event.which === 83
